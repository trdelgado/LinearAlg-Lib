...
class HyperPlane(object):
    ...
    EITHER_DIM_OR_NORMAL_VEC_MUST_BE_PROVIDED_MSG = "either the dimension of hyperplane or normal vector must be provided."

    def __init__(self, dimension=None, normal_vector=None, constant_term=None):
        if no dimension and not normal_vector:
